...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        hashTable.showListByHash("wayless");
        System.out.println();
        ...
        System.out.println("Search \"wayless\" = " + exists);
        if (exists){

            System.out.println("Deleting...");

            // функция удаления элемента из таблицы
            hashTable.delete("wayless");
        }

        // опять ищем тот же элемент, только теперь ожидаем результат false
        System.out.println("Search \"wayless\" = " + hashTable.search("wayless"));
        System.out.println();
